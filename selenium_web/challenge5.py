...
# for the comment to load then get the first two comments and print them on your terminal
...
def sweet_test(driver):
    driver.get("https://www.youtube.com/watch?v=Iw3WbIbeXEU&list=RDjHjaHygfWHA&index=16")
